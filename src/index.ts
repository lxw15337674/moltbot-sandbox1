...
function validateRequiredEnv(env: MoltbotEnv): string[] {
  ...
  if (
    ...
    missing.push(
      'ANTHROPIC_API_KEY, OPENAI_API_KEY, CUSTOM_OPENAI_BASE_URL + CUSTOM_OPENAI_API_KEY + CUSTOM_OPENAI_MODEL, or CLOUDFLARE_AI_GATEWAY_API_KEY + CF_AI_GATEWAY_ACCOUNT_ID + CF_AI_GATEWAY_GATEWAY_ID',
    );
  }
